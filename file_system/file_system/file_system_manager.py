...
class FileSystemManager():
    def __init__(self):
        ...
        self.current_path = [self.file_system.root.name]
        self.search_term = ""

    # TODO add an optional variable + function to get path for any file/dir
    def get_path(self, argline:str="") -> str:
    ...
    def create_directory(self, name: str) -> Node:
        ...
        dir_node = Node(name=name, node_type=NodeType.DIRECTORY)
    ...
    def create_file(self, name:str) -> Node:
        self._validate_name_availability(name)
        file_node = Node(name=name, node_type=NodeType.FILE)
